...
export default function ItilFoundation4() {
  return (
    <div className="bg-[#f8fafc] dark:bg-background-dark min-h-screen font-body text-primary dark:text-white">
      {/* Hero Section */}
      <header className="relative bg-[#071B34] text-white py-24 overflow-hidden border-b border-white/5">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_20%,_rgba(23,137,193,0.15)_0%,_transparent_60%)]"></div>
