...
const TEAM_MEMBERS = [
  {
    ...
    role: 'Founder',
    category: 'executive',
    bio: 'Misha Edara is the visionary Founder of Peer Consulting Resources. Under her strategic leadership, the firm has expanded from a local consulting outfit into a premier women-owned enterprise delivering large-scale technology operations and digital modernization frameworks to federal, state, and enterprise organizations.',
  ...
  },
  {
    ...
    role: 'Co-Founder',
    category: 'executive',
    bio: 'Vineela Mandava is the Co-Founder and Chief Operating Officer (COO) of Peer Consulting Resources, with over 15 years of experience in procurement, contract management, and business operations across healthcare, pharmaceutical, and New York City public-sector environments. She leads overall operational strategy and oversees core functions including HR, recruitment, finance operations, vendor management, and organizational execution. She brings deep expertise in strategic sourcing, commercial contracting, vendor governance, and process optimization, and has built scalable operational frameworks supporting complex, regulated environments.',
    quote: "Quality architecture isn't just about clean code—it's about aligning implementation to long-term client strategy.",
  ...
  },
  {
    ...
    role: 'CEO',
    category: 'executive',
    bio: "Vivek Philar brings over two decades of technology management and organizational leadership. As Chief Executive Officer, he guides the firm's global market alignment, client acquisitions, partnership networks, and comprehensive service operations.",
  ...
  },
  {
    ...
    category: 'management',
    bio: 'Naveen Marrivada coordinates key corporate client accounts and commercial operations across the New York metropolitan region. He translates client resource gaps into tailored technical talent and team support solutions.',
  ...
  },
  {
    ...
    category: 'management',
    bio: 'Omer Halilovic leads service operations and team deployment for our New York client network. He oversees delivery schedules, quality benchmarks, and cross-team execution across municipal and public engagements.',
  ...
  },
  {
    ...
    category: 'management',
    bio: 'Seema Mittal serves as Director – Recruiting & Client Delivery at Peer Consulting Resources, bringing over a decade of experience in recruitment leadership, client engagement, and delivery operations. She oversees recruiting operations, client coordination, consultant onboarding, and ongoing delivery support across public-sector and enterprise engagements. Seema has supported initiatives for leading New York City agencies, including the NYC Office of Technology and Innovation, the New York City Department of Education, the New York City Department of Health and Mental Hygiene, the New York City Police Department, and the Fire Department of the City of New York.',
  ...
  },
  {
    ...
    category: 'management',
    bio: "Sandeep Bussa serves as the Associate Director – HR, AP, AR & Administration at Peer Consulting Resources, where he leads human resources operations, employee engagement, payroll coordination, administrative functions, and workforce support across the company's U.S. and India teams. Known for his collaborative and people-focused leadership style, he is committed to building scalable processes, strengthening employee experience, and driving operational excellence that supports long-term organizational growth.",
            ...
            {contentVisible && (
              <>
                ...
                <div className="mb-7 bio-fade-up d3">
                  ...
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed font-body">{m.bio}</p>
                </div>
